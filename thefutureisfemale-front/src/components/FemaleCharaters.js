...
const FemaleCharacters = () => {
  return (
    <div className="card">
      <p><strong>Mariam et Laila</strong> - dans "Mille soleils splendides"</p>
      <p><strong>Gerda</strong> - dans "La Reine des Neiges"</p>
      <p><strong>Scarlett</strong> - dans "Autant en emporte le vent"</p>
      <p><strong>Gervaise</strong> - dans "L'Assommoir"</p>
